...
const dateOfIssuing = 'ns8:DateOfIssuing'
const dateOfReceipt = 'ns8:DateOfReceipt'
...
async function updateXml(xmlContent, formId = null, globalCaseId, parentFormId = null, subject = null) {
    ...
    parsedXml[root]["ns12:form"]["ns12:annexB"]["ns8:PartA"][dateOfIssuing] = moment().format('YYYY-MM-DD')
    parsedXml[root]["ns12:form"]["ns12:annexB"]["ns8:PartA"][dateOfReceipt] = moment().format('YYYY-MM-DD')
